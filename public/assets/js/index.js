  ...
  movieSection.innerHTML = `
    <div class="container">
      <div class="section-header">
        ...
        <a href="./detail.html" class="btn" onClick="getMovieList('${title}', '${title}')">
          View All
        </a>
      </div>

      <div class="section-body">
        <div class="movie-slider" movie-slider></div>
      </div>
    </div>
  `;

  const movieSlider = movieSection.querySelector("[movie-slider]");

  for (const movie of movieList) {
    movieSlider.appendChild(createMovieCard(movie));
  }

  pageContent.appendChild(movieSection);
};
